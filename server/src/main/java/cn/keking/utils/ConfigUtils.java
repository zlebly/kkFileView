...
public class ConfigUtils {
    ...
    private static String MAIN_DIRECTORY_NAME = "server";
    ...
    public static String getHomePath() {
        ...
        if (userDir.endsWith("bin")) {
            ...
            if (Strings.isEmpty(MAIN_DIRECTORY_NAME) || userDir.endsWith(MAIN_DIRECTORY_NAME)) {
    ...
    public static String getUserDir() {
        ...
        } else if (pluginPath.exists() && "bin".equals(pluginPath.getName())) {
            return pluginPath.getParentFile().getAbsolutePath();

        } else if (Strings.isNotEmpty(MAIN_DIRECTORY_NAME)) {
            return firstExists(new File(pluginPath, MAIN_DIRECTORY_NAME),
                    new File(pluginPath.getParentFile(), MAIN_DIRECTORY_NAME));
        } else {
            return firstExists(new File(pluginPath.getAbsolutePath()),
                    new File(pluginPath.getParentFile().getAbsolutePath()));
        }
    }
